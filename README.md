...
The test suite doubles as the reference wiring; here is a complete run you can paste as-is —
stub adapters over an in-memory corpus, driving the real engine and gate:
